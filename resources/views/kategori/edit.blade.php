        ...
        <div class="card-body p-4">
            <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    @enderror" id="nama_kategori" name="nama_kategori" value="{{ old('nama_kategori', $kategori->nama_kategori) }}" placeholder="Masukkan nama kategori">
                    @error('nama_kategori')
                ...
                <div class="mb-4">
                    ...
                    @enderror" id="keterangan" name="keterangan" rows="4"
